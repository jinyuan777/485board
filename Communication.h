...
typedef enum 
{
	BoardCommand_RxCasseteInfo = 'A',
	BoardCommand_StateReruen   = 'B',
	BoardCommand_Start		   = 'C',				
	BoardCommand_ACK           = 'D',
	BoardCommand_Busy		   = 'E',
	BoardCommand_Idel		   = 'F',
	BoardCommand_ReStart	   = 'G',
	BoardCommand_LEDON		   = 'H',
	BoardCommand_LEDOFF		   = 'I'
} E232Command;
// --------------------------------------------------------
